...
const PersonalizationPreferences = (props) => {
  ...
  const handleOnButton1Clicked = (e) => {
    e.preventDefault();
    console.log("a");
  }
  const handleOnButton2Clicked = (e) => {
    e.preventDefault();
    console.log("b");
  }
  const handleOnButton3Clicked = (e) => {
    e.preventDefault();
    console.log("c");
  }
  const handleOnButton4Clicked = (e) => {
    e.preventDefault();
    console.log("d");
  }
      ...
      >
        ...
        <div style={{ marginTop: `${100 * scaleFactor}px` }}>
          ...
          >
            <div style={{ width: `${200 * scaleFactor}px` }}>
              <div style={{ height: `${200 * scaleFactor}px` }}>
                <button className="hover:border-[#FD71AE] hover:border hover:rounded-[25px]" onClick={handleOnButton1Clicked}>
                  <svg
            ...
            <div style={{ width: `${200 * scaleFactor}px` }}>
              <div style={{ height: `${200 * scaleFactor}px` }}>
                <button className="hover:border-[#92E3FF] hover:border hover:rounded-[25px]" onClick={handleOnButton2Clicked}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div style={{ width: `${200 * scaleFactor}px` }}>
              <div style={{ height: `${200 * scaleFactor}px` }}>
                <button className="hover:border-[#FFE070] hover:border hover:rounded-[25px]" onClick={handleOnButton3Clicked}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={201 * scaleFactor}
                    height={200 * scaleFactor}
            ...
            <div style={{ width: `${200 * scaleFactor}px` }}>
              <div style={{ height: `${200 * scaleFactor}px` }}>
                <button className="hover:border-[#64FF8D] hover:border hover:rounded-[25px]" onClick={handleOnButton4Clicked}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={200 * scaleFactor}
                    height={200 * scaleFactor}
          ...
          >
            ...
            <span
              className="text-[#3BA8CE]"
              style={{ marginLeft: `${4 * scaleFactor}px` }}
            >
